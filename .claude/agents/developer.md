...
6. Quando finisci: produci sempre un REPORT_CAP_XX.md nella cartella reports/ con il formato supervisore definito sotto. Poi scrivi tasks/DEV_STATUS.md con "READY_FOR_REVIEW". Non aprire nuovi task.
...
2. Development scrive tasks/DEV_STATUS.md con "READY_FOR_REVIEW" e si ferma. Non apre nuovi task.
3. L'orchestratore avvia automaticamente il subagente Review.
...
5. Se Review emette FAIL o CONDITIONAL:
   ...
   - Development scrive di nuovo tasks/DEV_STATUS.md con "READY_FOR_REVIEW"
...
7. Solo quando Review emette PASS, l'orchestratore chiama il Planner per il task successivo.
