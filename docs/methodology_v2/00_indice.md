...
## Parte VII — Validazione OOS, frozen bundle, gate decisionali (~8 pp) 🟡 IN REVIEW Review v1 (documento v1 commit pending del 2026-05-27; 6 capitoli Cap.31-36 prodotti; 32 eredità da CAP-01..CAP-06 integrate; 2 M-promemoria pertinenti trattati — M-2 OPEN qualitativo carryover Appendice E, M-16 OPEN-CONDIZIONALE chiuso in Cap.31.3 con regola di attivazione/disattivazione + metadato bundle `cox_time_varying_active`; 5 decisioni di scope del Planner applicate verbatim — (a) M-2 OPEN qualitativo, (b) M-16 regola chiusura condizionale, (c) no congelamento empirico 10 parametri Parte VI carryover monitoring post-go-live, (d) compute stress test regola deterministica fra opzioni (i)/(ii)/(iii) con aritmetica esplicita, (e) bootstrap su cloud c5.4xlarge entro <5% compute budget; 12 parametri di tuning provvisori introdotti — $\theta_{DSR}, \theta_{PBO}, \theta_{f_5}, \theta_{IQR}, \theta_{t_2}, \epsilon_{f_1}, \theta_{CVaR}, \theta_{MDD}, \theta_{sessions}, S, L_{avg}, \theta_{cost}$ — tutti dichiarati non congelati in Parte VII; 41 AC + 11 AC-T trasversali + 12 AC-GO checklist go-live tutti OK; ciclo Review v1 in corso)
