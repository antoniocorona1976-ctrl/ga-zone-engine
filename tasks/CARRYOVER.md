...
|------|---------|-----------|--------------|-------|
| M-2  | Review v1 CAP-02 | Verifica empirica latenza Telegram ($L_{max}=30$s) | Appendice E | OPEN — requisito incardinato come **NFR-6.2** `[B-1 PROVVISORIO]` in SPEC-FUNZ-01 v2 (`ab7450f`, 2026-06-14; era NFR-1 nella v1 `a16a4c0`); la verifica empirica del valore resta a Appendice E / FASE-D |
