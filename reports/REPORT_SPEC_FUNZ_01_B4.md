...
**Iter.2 (rework micro-fix citazioni, CONDITIONAL f369276):** confermo di aver riletto, prima di agire, in quest'ordine: (1) tasks/METODO.md (RM-1..RM-4); (2) .claude/BASE_COMUNE.md (onesta claim->evidenza par.8); (3) .claude/agents/spec_developer.md; (4) tasks/ACTIVE_TASK.md §8 "Finding di Review da risolvere" (tabella dei 4 fix). Le righe-paragrafo target (:148, :156, :192) ri-verificate token-per-token su CAP_06_parte_VI.md (sola lettura, frozen G-09) prima di ri-citarle. Dettaglio del micro-fix: §3 Decisioni (estensione) punto 6 + tabella AC-G7.
...
6. Micro-fix iter.2 (rework su CONDITIONAL f369276, finding #1 BUG REALE + #2/#3/#4 MIGLIORA approvati da AC): correzione di SOLO puntatore-riga, nessun cambio di contenuto/proposizione/scope. Quattro citazioni puntavano all'header di sottosezione (### 29.x) invece che al paragrafo di contenuto immediatamente successivo (convenzione CAP_06: header e paragrafo sono righe distinte). Corretto: B4-NFR-06 (:154 header rimosso, aggiunto :148 paragrafo; :146 mantenuto), B4-R-35 (:154->:156; :220 mantenuto), B4-R-36 (:190->:192; :220 mantenuto), B4-R-37 (:190->:192). Ogni nuova riga (:148, :156, :192) ri-verificata token-per-token su CAP_06_parte_VI.md prima di ri-citarla (AC-G7). Le righe corrispondenti della matrice E.6 sono state allineate. Finding #5 (B4-R-38 :223 ridondante, NEUTRO) NON instradato: lasciato invariato. Parte CAP_02 Cap.8-9 (PASS c3be05e) e CAP frozen (G-09) non toccati. VERIFICA: :192 contiene "non modifica il messaggio di emissione (no edit, no append)" e "signal_id esplicito"; :148 contiene "Nessun campo nuovo viene introdotto nel payload formale" + "payload formale (immutabile) vs rappresentazione mobile (cosmetica)"; :156 contiene "Le 9 voci pubblicate ... riordinate per priorita di lettura mobile ... esattamente 9". PROVE: lettura diretta di CAP_06_parte_VI.md:144-228 (sola lettura, file frozen) e confronto puntuale con i costrutti dei 4 requisiti. ALTERNATIVE ESCLUSE: che le righe header (:154, :190) contenessero i costrutti (escluso: :154 e ":190 sono solo i titoli di sottosezione "### 29.2"/"### 29.3", privi del testo del costrutto). ALTERNATIVE NON ESCLUSE: nessuna rilevante (solo puntatore-riga; il testo dei requisiti e immutato).
...
| AC-G7 Floor citazioni 100% (mia ri-verifica token-per-token) | OK (mio campione = tutte le 11; 4 citazioni corrette in iter.2 header->paragrafo) | Ri-verificate contro CAP_06_parte_VI.md: :146 (29.1 mobile-first "rappresentato in un layout mobile-first") -> B4-NFR-05/06; :148 (29.1 paragrafo "Nessun campo nuovo viene introdotto nel payload formale ... payload formale (immutabile) vs rappresentazione mobile (cosmetica)") -> B4-NFR-06; :152 (vincoli leggibilita "senza scroll orizzontale") -> B4-NFR-07; :156 (29.2 paragrafo "Le 9 voci pubblicate ... riordinate per priorita di lettura mobile ... numero totale di voci pubblicate e esattamente 9") -> B4-R-35; :192 (29.3 paragrafo "non modifica il messaggio di emissione (no edit, no append)" + "signal_id esplicito") -> B4-R-36/37; :220 ("esattamente 3 notifiche standard per segnale" + "no polling, no refresh") -> B4-R-33/34/35/36/38; :223 (29.5 "Notifica di transizione terminale") -> B4-R-38; :225 (transizione active->stati terminali) -> B4-R-38; :230 ("stato terminale finale, uno dei 6") -> B4-R-39; :232 ("R_gross ... vuoto o n/a per i segnali non eseguiti") -> B4-R-40. Tutte risolvono token-per-token. In iter.2 le 4 citazioni B4-NFR-06 (:154->:148), B4-R-35 (:154->:156), B4-R-36 (:190->:192) e B4-R-37 (:190->:192) sono state spostate dall'header di sottosezione al paragrafo di contenuto immediatamente successivo (convenzione CAP_06: header e paragrafo sono righe distinte). Floor esaustivo finale = Reviewer per ruolo. |
