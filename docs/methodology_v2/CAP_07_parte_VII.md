...
La **Probability of Backtest Overfitting** (PBO) è introdotta da Bailey, Borwein, López de Prado e Zhu (2017) "The Probability of Backtest Overfitting", *Journal of Computational Finance* 20(4), 39-70 (cfr. anche Bailey, Borwein, Lopez de Prado, Zhu 2014 "Pseudo-Mathematics and Financial Charlatanism: The Effects of Backtest Overfitting on Out-of-Sample Performance", *Notices of the American Mathematical Society* 61(5), 458-471), come misura della probabilità che il cromosoma vincente in-sample sia overfit, ovvero che in OOS performi sotto la mediana del fronte di Pareto. Il PBO è stimato via **Combinatorially Symmetric Cross-Validation** (CSCV).
