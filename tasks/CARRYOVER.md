...
| M-2 v2 CAP-03 | Review v2 CAP-03 | Cadenza ricalibrazione EGARCH in production non specificata | Parte V/VI | CLOSED-CAP-05 parziale (Cap.25.9: walk-forward fold-per-fold chiuso in Parte V; cadenza temporale fissa + trigger break parametrico real-time resta carryover Parte VI Cap.27) |
...
| M-11 | Developer CAP-04 | Dimensionalita' massima del vettore di feature $\tilde{\mathbf{x}}$ nel survival | Parte V | CLOSED-CAP-05 (Cap.22.6 + Cap.26.7 post-rework v2: $K_{max}=6$ per strato congelato; Harrell 2015 rispettato sotto split 50/50 con $N_{eventi,strato} \geq 60$) |
...
| M-16 condizionale | Review v1 CAP-05 (Cap.25.8 trigger) | Estensione a Cox time-varying coefficients se test Schoenfeld viola sistematicamente in >50% dei fold | Parte VII (calibrazione bundle frozen) | OPEN-CONDIZIONALE (attivo solo se l'analisi empirica Parte VII trova violazione sistematica) |
